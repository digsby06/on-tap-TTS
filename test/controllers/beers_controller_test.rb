...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { name: @beer.name, rating: @beer.rating, review: @beer.review, sold: @beer.sold, style_type: @beer.style_type }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { name: @beer.name, rating: @beer.rating, review: @beer.review, sold: @beer.sold, style_type: @beer.style_type }
    assert_redirected_to beer_path(assigns(:beer))
  end
